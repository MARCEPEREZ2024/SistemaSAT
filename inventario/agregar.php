                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="codigo" class="form-control" required placeholder="ej: DIS-001">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="marca_compatible" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Modelo Compatible</label>
                            <input type="text" name="modelo_compatible" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="precio_compra" class="form-control" value="0" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">S/</span>
                                <input type="number" name="precio_venta" class="form-control" value="0" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
