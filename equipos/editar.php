                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="marca" class="form-control" value="<?= htmlspecialchars($equipo['marca']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="passwordBIOS" class="form-control" value="<?= htmlspecialchars($equipo['passwordBIOS'] ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Contraseña SO</label>
                            <input type="text" name="passwordSO" class="form-control" value="<?= htmlspecialchars($equipo['passwordSO'] ?? '') ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" name="fecha_ingreso" class="form-control" value="<?= $equipo['fecha_ingreso'] ?>">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label">Diagnóstico Inicial</label>
                    <textarea name="diagnostico_inicial" class="form-control" rows="2"><?= htmlspecialchars($equipo['diagnostico_inicial'] ?? '') ?></textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label">Accesorios</label>
                    <textarea name="accesorios" class="form-control" rows="2"><?= htmlspecialchars($equipo['accesorios'] ?? '') ?></textarea>
                </div>
